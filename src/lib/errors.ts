...
export const ERROR_MESSAGE_KEYS = {
  ...
  rangeBackwards: 'errors.rangeBackwards',
  ...
  pastGapFrozen: 'errors.pastGapFrozen',
  dropOntoPastDay: 'errors.dropOntoPastDay',
  gapOverGap: 'errors.gapOverGap',
  ...
  closedDayOverLockedBlock: 'errors.closedDayOverLockedBlock',
  closedDayOverPastBlock: 'errors.closedDayOverPastBlock',
  closedDayOverWeekendBlock: 'errors.closedDayOverWeekendBlock',
